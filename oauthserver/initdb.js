					...
					client.query('SET search_path = admin', function(err, result) {
						...
						if(err) {
						  ...
						  return console.error('set default search path', err);
							...
							client.query('CREATE TABLE IF NOT EXISTS authorizationRelation(id SERIAL primary key,username varchar(50) NOT NULL,consumer varchar(50) NOT NULL,resourceowner varchar(50) NOT NULL,active boolean,createdate varchar(50),updatedate varchar(100))', function(err, result) {
